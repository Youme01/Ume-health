 ...
 * {@link Food_tips.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Food_tips#newInstance} factory method to
...
public class Food_tips extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        anaemia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FragmentTransaction ft = getActivity().getSupportFragmentManager().beginTransaction();
    ...
    public void setUpViews(){
         ...
         * @return A new instance of fragment Food_tips.
         */
    // TODO: Rename and change types and number of parameters
    public static Food_tips newInstance(String param1, String param2) {
        Food_tips fragment = new Food_tips();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_food_tips, container, false);
    }
